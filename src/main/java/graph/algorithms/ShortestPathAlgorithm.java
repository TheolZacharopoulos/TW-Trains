...
public class ShortestPathAlgorithm {
    ...
    private static <T> Vertex<T> getClosestNeighbour(Map<Vertex<T>, VertexInfo> info) {
     ...
     */
    public static <T> Optional<Integer> findShortestPath(Graph<T> graph, Vertex<T> start, Vertex<T> end) {
